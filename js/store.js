  ...
  function defaults() {
    return {
      ...
      settings: {
        ...
        scalesCollapsed: false,  // collapse the scales column to a slim rail
        stripCollapsed: false,   // collapse the chords/triads strip to a slim top rail
        scalesKind: 'pent'       // scales column flavor: 'pent' | 'full' | 'modes'
      }
    };
  }
